...
employeecompensationhistory = 'employee_compensation_history'
organisationbranches = 'organisation_branches'
employeehistory = 'employee_history'
previouscompanyhistory = 'previous_company_history'
employeesalary = 'employee_salary'
hardware = 'hardware'
salarycomponents = 'salary_components'
employeesalarycomponents = 'employee_salary_components'
benefits = 'benefits'
benefitproviders= 'benefit_providers'
employeebenefits = 'employee_benefits'
employeebenefitproviders = 'employee_benefit_providers'
employeeonboarding = 'employee_onboarding'
employeehardwareassignment = 'employee_hardware_assignment'
