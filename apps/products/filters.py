...
class ProductsFilter(FilterSet):
    ...
    pack_unit_name = filters.CharFilter(field_name='pack_unit_id__unit_name', lookup_expr='icontains') 
    g_pack_unit_id = filters.CharFilter(method=filter_uuid)
    g_pack_unit_name = filters.CharFilter(field_name='g_pack_unit_id__unit_name', lookup_expr='icontains')         
