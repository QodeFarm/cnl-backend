...
class LedgerAccounts(models.Model):
    ...
    ledger_group_id = models.ForeignKey(LedgerGroups, on_delete=models.PROTECT, db_column='ledger_group_id')
...
class CustomerAddresses(models.Model):
    ...
    country_id = models.ForeignKey(Country, on_delete=models.PROTECT, null=True, default=None, db_column='country_id')
