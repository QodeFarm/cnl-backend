...
urlpatterns = [
    ...
    path('uploads/<str:folder_name>/', FileUploadView.as_view(), name='file_uploads'),
    path('uploads/<str:folder_name>/<str:subfolder_name>/', FileUploadView.as_view(), name='file_uploads'),
