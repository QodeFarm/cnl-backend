...
def payment_receipt_data(pk, document_type):
    ...
    # Get billing address — guard against customer being None
    ...
    return {
        ...
        'invoice_date': _fmt_date(payment_data.get('invoice_date')),
...
def payment_receipt_doc(
    ...
    elements.append(payment_customer_details(customer_name, billing_address, phone, email, print_config=print_config))
