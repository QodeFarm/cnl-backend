...
class SaleOrderPDFView(APIView):
    ...
    def send_whatsapp_message_via_wati(self, to_number, file_url):
        ...
        headers = {
        'accept': '*/*',
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..viHuj05mTnctNiYRWakVRJLBsK5io7oCl2xzIWQp9rA',
        }
