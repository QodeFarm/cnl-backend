...
class BOMFilter(filters.FilterSet):
    ...
    class Meta:
        model = BOM 
        fields = ['product','created_at','bom_id','bom','product_id','notes','s', 'sort','page','limit']
...
class MachineFilter(filters.FilterSet):
    ...
    description = filters.CharFilter(field_name='description', lookup_expr='icontains')  # Added description filter
...
class ProductionStatusFilter(filters.FilterSet):
    status_id = filters.UUIDFilter(field_name='status_id')  
    ...
    class Meta:
        ...
        fields = ['status_id', 'status_name', 'description', 'created_at', 'updated_at', 's','sort', 'page', 'limit']