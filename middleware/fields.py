...
all_model_fields = {
    ...
    'sale_order_search':['sale_order_id','sale_type_id','order_no','order_date','customer_id','gst_type_id','email','delivery_date','ref_no','ref_date','tax','customer_address_id','payment_term_id','remarks','advance_amount','ledger_account_id','item_value','discount','dis_amt','taxable','tax_amount','cess_amount','round_off','doc_amount','vehicle_name','total_boxes','order_status_id','created_at','updated_at'],
    'sale_order':['order_date','order_no','sale_type','customer','item_value','tax','advance_amount','order_status'],
